...
- Fixed first login issue: user profile and access token not saved
- 修复首次登录时用户信息和访问令牌未保存的问题
- Use linkAccount event to ensure data is written after user creation
- 使用 linkAccount 事件确保用户创建后写入数据
